                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <center><img id="coverImageShow" src="{{$slider->slider_image}}" width="70%"
                                                 height="350px"></center>
                                    <br>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input id="coverImage" type="file" name="slider_image"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="slider_name" value="{{$slider->slider_name}}"
                                ...
                                <!--<div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="slider_status"
                                               {{$slider->slider_status == 'on' ? 'checked' : ' '}} data-bootstrap-switch>
                                    </div>
                                </div>
