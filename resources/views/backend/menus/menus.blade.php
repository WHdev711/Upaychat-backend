                        ...
                        <table class="example1 table table-bordered table-striped">
                            ...
                            @foreach($menus as $menu)
                                <tr id="item-{{$menu->id}}">
                                    ...
                                    <td>
                                        <a href="{{route('menu-edit',$menu->id)}}" class="btn btn-primary"><i
                                                class="fas fa-edit"></i>&nbsp;Düzenle</a>
                                        <button class="btn btn-danger" onclick="deleteMenus(this,'{{$menu->id}}')"><i
                                                class="fas fa-trash-alt"></i>&nbsp;Sil
                                        </button>
                                        @if($menu->menu_status == 'on')
                                            <button class="btn btn-success"
                                                    onclick="menuStatus(this,'{{$menu->id}}','off')"><i
                                                    class="fas fa-eye-slash"></i>Pasif
                                            </button>
                                        @else
                                            <button class="btn btn-success"
                                                    onclick="menuStatus(this,'{{$menu->id}}','on')"><i
                                    ...
                                    <tr id="item-{{$downMenu->id}}">
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-danger"
                                                    onclick="deleteMenus(this,'{{$downMenu->id}}')"><i
                                                    class="fas fa-trash-alt"></i>&nbsp;Sil
                                            </button>

                                            @if($downMenu->menu_status == 'on')
                                                <button class="btn btn-success"
                                                        onclick="menuStatus(this,'{{$downMenu->id}}','off')"><i
                                                        class="fas fa-eye-slash"></i>Pasif
                                                </button>
                                            @else
                                                <button class="btn btn-success"
                                                        onclick="menuStatus(this,'{{$downMenu->id}}','on')"><i
                                                        class="fas fa-eye"></i>Aktif
                                                </button>
                                            @endif
                                        </td>
