    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Show Transactions By user</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Show Transactions By user</li>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <td>
                                        <a href="{{route('users-transactions',$user->id)}}"
                                           class="btn btn-primary btn-sm">
                                            <i class="fas fa-search btn-xs"></i>&nbsp;View Transactions</a>
